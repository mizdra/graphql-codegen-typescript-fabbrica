...
const config: CodegenConfig = {
  generates: {
    ...
    '__generated__/5-non-local-schema/types.ts': {
      schema: './5-non-local-schema-schema.json', // generated by https://transform.tools/graphql-to-introspection-json
      plugins: ['typescript'],
      config: defaultTypeScriptPluginConfig,
    },
    './__generated__/5-non-local-schema/fabbrica.ts': {
      schema: './5-non-local-schema-schema.json', // generated by https://transform.tools/graphql-to-introspection-json
      plugins: ['@mizdra/graphql-codegen-typescript-fabbrica'],
